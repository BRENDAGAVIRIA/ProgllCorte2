...
# Encuentre la longitud de las dos listas creadas anteriormente.
...
#Crear una lista llamada Datos_personales que contenga (nombre, edad, altura, estado civil, dirección), y agrega datos utilizando la funcion append().
datos_personales = []
datos_personales.append("Brenda")
datos_personales.append(18) # Edad
datos_personales.append(1.62)
datos_personales.append("Viuda")
datos_personales.append("Las gaviotas")

#Crea una lista llamada it_companies y asígnele los valores iniciales Facebook, Google, Microsoft, Apple, IBM, Oracle y Amazon.
it_companies = ["Facebook", "Google", "Microsoft", "Apple", "IBM", "Oracle", "Amazon"]

#Añadir una empresa a la lista it_companies utilizando la funcion insert().
...
#Elimine la primera empresa informática de la lista utilizando el método pop y delete.
primer_empresa = it_companies.pop(0)

#Eliminar todas las empresas de la lista it_companies en python
it_companies.clear()
